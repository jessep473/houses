...
class WallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wall" do
    assert_difference('Wall.count') do
      post walls_url, params: { wall: { description: @wall.description, name: @wall.name, picture: @wall.picture } }
    end
  ...
  test "should update wall" do
    patch wall_url(@wall), params: { wall: { description: @wall.description, name: @wall.name, picture: @wall.picture } }
